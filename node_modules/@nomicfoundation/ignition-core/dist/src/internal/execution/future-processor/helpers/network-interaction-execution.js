...
async function sendTransactionForOnchainInteraction(client, sender, onchainInteraction, getNonce, decodeSimulationResult) {
    ...
    try {
        ...
        // estimation errors.
        const failedEstimateGasSimulationResult = await client.call(estimateGasPrams, // TODO: we need to set a gas limit here, or the simulation could fail due to a lack of funds
        "pending");
