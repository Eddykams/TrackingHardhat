...
function canTimeout(exState) {
    return (exState.type === execution_state_1.ExecutionSateType.DEPLOYMENT_EXECUTION_STATE ||
        exState.type === execution_state_1.ExecutionSateType.CALL_EXECUTION_STATE ||
